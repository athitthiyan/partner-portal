...
describe('partner environments', () => {
  it('exports the development environment config', () => {
    ...
    expect(devEnvironment.bookingAppUrl).toBe('https://stayease-partner-portal.vercel.app/');
  });
  ...
  it('exports the production environment config', () => {
    ...
    expect(prodEnvironment.bookingAppUrl).toBe('https://stayease-partner-portal.vercel.app/');
  });
});
